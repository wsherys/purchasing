              ...
              <?php 
                ...
                if($kelas!='admin')
                {
                    ...
                    echo '<script language="javascript">
                           alert ("Tidak diperbolehkan akun dalam 1 browser.");
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li>
                    <a href="<?php echo site_url('admin/request');?>"><i class=""></i> 
                  ...
                  <!-- <li><a><i class="fa fa-desktop"></i> Inventory PC <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo site_url('admin/inventory_pc');?>">General Form</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Inventory Printer <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.html">General Form</a></li>
                      <li><a href="form_advanced.html">Printer Form</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Inventory Scanner <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.html">General Form</a></li>
                      <li><a href="form_advanced.html">Scanner Form</a></li>
                    </ul>
                  </li> -->
