            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">DATA PROCESS DELIVERED</h4>
                </div>
                <div class="modal-body">
                  ...
                  <?php 
                    ...
                    $qubh=$this->db->query("SELECT * FROM po_process WHERE id='".$id."' ")->result();
                    foreach ($qubh as $key) 
                    {
                      ...
                      elseif(empty($key->no_po))
                      {
                        echo '
                        <div class="alert alert-danger">
                          <strong>Kesalahan!</strong> kesalahan pada no purchase order atau no purchase order kosong!.
                        </div>
                        ';
                      }
                      elseif(empty($key->vendor))
                      {
                        echo '
                        <div class="alert alert-danger">
                          <strong>Kesalahan!</strong> kesalahan pada vendor atau vendor  kosong!.
                        </div>
                        ';
                      }
                      elseif(empty($key->status))
                      {
                        echo '
                        <div class="alert alert-danger">
                          <strong>Kesalahan!</strong> kesalahan pada status atau status kosong!.
                        </div>
                        ';
                      }
                  ...
                  <form action="<?php echo site_url('ctrl_ubah_delivered/proses_delivered');?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >No Request 
                        </label>
                        <div class="input-group col-md-6 col-sm-6 col-xs-12">
                          <input type="no_request" name="no_request" placeholder="harap masukkan no request" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-md-6 col-sm-6 col-xs-12">
                          <input readonly="" name="no_po" id="no_po" required="required" value="<?php echo $key->no_po;?>"  placeholder="harap masukkan no purchase order" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-md-6 col-sm-6 col-xs-12">
                          <input readonly="" name="vendor" id="vendor" required="required" value="<?php echo $key->vendor;?>"  placeholder="harap masukkan vendor" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-md-6 col-sm-6 col-xs-12">
                          <input readonly="" name="status" id="status" required="required" value="<?php echo $key->status;?>"  placeholder="harap masukkan vendor" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
