                    ...
                    <form action="<?php echo site_url('admin/proses_request');?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-md-6 col-sm-6 col-xs-12">
                          <input name="no_request"  placeholder="harap masukkan no request" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-md-6 col-sm-6 col-xs-12">
                          <input name="nama_proyek" id="nama_proyek" required="required" placeholder="harap masukkan nama proyek" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-md-6 col-sm-6 col-xs-12">
                          <input type="number" name="quantity" id="quantity" required="required" placeholder="harap masukkan quantity" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-md-6 col-sm-6 col-xs-12">
                          <input name="description" id="description" required="required" placeholder="harap masukkan deskripsi" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class='input-group date col-md-6 col-sm-6 col-xs-12' id='datereq'>
                            <input  name="tanggal_request"  placeholder="masukkan tanggal" class="form-control col-md-7 col-xs-12" />
