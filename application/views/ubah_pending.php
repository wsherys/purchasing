            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">DATA PROCESS PENDING</h4>
                </div>
                <div class="modal-body">
                  ...
                  <?php 
                    ...
                    $qubh=$this->db->query("SELECT * FROM po_pending WHERE id='".$id."' ")->result();
                    foreach ($qubh as $key) 
                    {
                  ...
                  <form action="<?php echo site_url('ctrl_ubah_pending/proses_pending');?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-md-6 col-sm-6 col-xs-12">
                          <input name="no_po" id="no_po" required="required" value="<?php echo $key->no_po;?>"  placeholder="harap masukkan no purchase order" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-md-6 col-sm-6 col-xs-12">
                          <input name="vendor" id="vendor" required="required" value="<?php echo $key->vendor;?>"  placeholder="harap masukkan vendor" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
